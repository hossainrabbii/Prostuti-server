...
const createEnrollmentIntoDB = async (payload: IEnrollment) => {
...
const getStudentEnrollmentsFromDB = async (studentId: string) => {
...
const updateEnrollmentStatusInDB = async (id: string, status: string) => {
