...
const saveOrUpdateLinksInDB = async (payload: ILinks): Promise<ILinks | null> => {
  const result = await Links.findOneAndUpdate(
    {}, // ফাকা অবজেক্ট মানে ডাটাবেজের প্রথম যে ডকুমেন্টটি পাবে সেটাই আপডেট করবে
    payload,
    {
      new: true,
...
const getLatestLinksFromDB = async (): Promise<ILinks | null> => {
